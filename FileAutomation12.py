...
def DirectoryTravel(DirName,extension):
        ...
        for foldername, subfoldername, filename in os.walk(DirName):
            for fname in filename:
                if fname.endswith(extension):
                    ...
                    print("File is present in the directory with the extension : ",fname,extension)
                    print("Removing Files :",file_path)
                    os.remove(file_path)
        print("Total number of deleted files are : ",cnt)
