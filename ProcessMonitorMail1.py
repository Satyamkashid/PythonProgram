...
def send_email(log_filename):
    ...
    try:
        ...
        # Loop through recipient email addresses and send the email
        for receiver_email in receiver_emails:
            ...
            print(f'Email with attachments sent to {receiver_email} successfully!')

    except Exception as e:
        print(f'Error: {str(e)}')

    finally:
        # Close the SMTP server connection after sending all emails
        server.quit()
